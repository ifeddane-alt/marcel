...
ALL_PERMISSIONS = [
    ...
    {"key": "architecture.manage",         "label": "Gérer les référentiels Architecture", "module": "Architecture"},
    {"key": "security.manage",             "label": "Gérer les référentiels Sécurité", "module": "Sécurité"},
    {"key": "pb.manage",                   "label": "Gérer les sessions de participatory budgeting", "module": "Participatory Budgeting"},
]
...
DEFAULT_PROFILES = [
    ...
    },
    {
        ...
        "permissions": [
            ...
            "applications.manage", "architecture.manage", "security.manage", "indicators.manage", "import.data",
            "objectives.manage", "okrs.manage", "engagement.manage",
            "run.manage", "run.delete", "safe.manage", "pb.manage",
        ],
    },
    {
        "code": "CHEF_DE_PROJET",
    ...
    },
    {
        ...
        "permissions": [
            ...
            "lifecycle.review_architecture", "applications.manage", "architecture.manage", "indicators.manage",
        ],
    },
    {
        "code": "SECURITE",
        ...
        "permissions": [
            ...
            "demands.view_own", "lifecycle.review_security", "security.manage",
        ],
    },
    {
        "code": "FINANCE",
