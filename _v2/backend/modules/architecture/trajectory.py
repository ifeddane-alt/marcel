...
async def set_disposition(application_id: str, data: dict,
                          current_user: TokenPayload = Depends(permission_required("architecture.manage"))):
    updates = {}
...
async def create_milestone(data: dict, current_user: TokenPayload = Depends(permission_required("architecture.manage"))):
    doc = {
