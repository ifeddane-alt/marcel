    ...
    <Modal isOpen={isOpen} onClose={onClose} title={title || "Confirmer la suppression"} size="sm">
      <div className="space-y-4" data-testid="confirm-dialog">
        <div className="flex items-start gap-3 p-3 bg-rose-50 border border-rose-200 rounded-lg">
          ...
          <p className="text-sm text-zinc-700">{message || "Cette action est irréversible."}</p>
        </div>
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2 bg-rose-600 text-white text-sm font-semibold rounded-lg hover:bg-rose-700 disabled:opacity-50 transition-colors"
          >
