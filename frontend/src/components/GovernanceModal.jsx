              ...
              <div className="space-y-2">
                {agenda.map((item, i) => (
                  <div key={i} className="flex items-center gap-2">
                    <span className="font-mono-data text-xs font-bold text-blue-600 w-5 flex-shrink-0">{i + 1}.</span>
                    <input value={item.title} onChange={(e) => updateAgendaItem(i, "title", e.target.value)}
                      ...
                      className="flex-1 text-sm border border-zinc-200 rounded-lg px-3 py-1.5 focus:outline-none focus:border-blue-600" />
                    <input value={item.presenter} onChange={(e) => updateAgendaItem(i, "presenter", e.target.value)}
                      ...
                      className="w-32 text-sm border border-zinc-200 rounded-lg px-3 py-1.5 focus:outline-none focus:border-blue-600" />
                    <input type="number" min="0" value={item.duration_min} onChange={(e) => updateAgendaItem(i, "duration_min", e.target.value)}
                      ...
                      className="w-16 text-sm border border-zinc-200 rounded-lg px-2 py-1.5 focus:outline-none focus:border-blue-600 font-mono-data" />
