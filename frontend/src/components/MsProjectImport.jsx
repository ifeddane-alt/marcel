  ...
  return (
    <>
      <button onClick={() => setOpen(true)} data-testid="msproject-import-btn"
        className="flex items-center gap-1.5 px-3 py-2 text-sm border border-gray-200 bg-white rounded hover:bg-gray-50 text-slate-600 transition-colors"
        ...
        <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4"
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md">
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
              <h3 className="font-heading font-bold text-[#0F172A]">Importer un plan MS Project</h3>
            ...
            <div className="px-5 py-4 space-y-4">
              <div>
                ...
                <select value={projectId} onChange={(e) => setProjectId(e.target.value)}
                  ...
                  className="w-full text-sm border border-gray-200 rounded px-3 py-2 bg-white focus:outline-none focus:border-[#0052CC]">
              ...
              <div>
                ...
                <button onClick={() => fileRef.current?.click()}
                  ...
                  className="w-full flex items-center gap-2 px-3 py-2.5 text-sm border border-dashed border-gray-300 rounded text-slate-500 hover:border-[#0052CC] hover:text-[#0052CC] transition-colors">
                  <FileUp size={14} />
            ...
            <div className="flex items-center justify-end gap-2 px-5 py-4 border-t border-gray-100">
              ...
              <button onClick={doImport} disabled={busy || !projectId || !file}
                ...
                className="flex items-center gap-1.5 px-4 py-2 text-sm font-semibold bg-[#0052CC] text-white rounded hover:bg-[#0047B3] disabled:opacity-50">
