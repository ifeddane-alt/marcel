...
- **Participatory Budgeting SAFe (demandé Juin 2026)** : rituel LPM de répartition collective du budget portefeuille entre value streams/epics. Sessions PB (enveloppe + participants invités), budget fictif distribué par chaque participant, restitution consolidée vs répartition actuelle, résultat alimentant les guardrails budgétaires des value streams pour le PI suivant. S'intègre au module SAFe existant (trains, PI, epics). Différenciateur : absent de PPM Express et Cora.
